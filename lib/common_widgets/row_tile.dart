  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Text(
          title,
          style: TextFontStyle.headline20StyleMontserrat
              .copyWith(color: AppColors.c0A0909, fontWeight: FontWeight.w600, fontSize: 19.sp),
        ),
        const Spacer(),
        if (showGoToIcon)
          InkWell(
                ...
                children: [
                  Text(
                    ...
                    style: TextFontStyle.headline12StyleMontserrat
                        .copyWith(color: AppColors.c0A0909, fontWeight: FontWeight.w400),
                  ),
